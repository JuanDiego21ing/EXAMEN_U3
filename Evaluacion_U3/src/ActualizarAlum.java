...
public class ActualizarAlum {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ActualizarAlum window = new ActualizarAlum();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Actualizar Datos Alumno");
		lblNewLabel.setFont(new Font("Arial Black", Font.PLAIN, 30));
		lblNewLabel.setBounds(67, 25, 412, 43);
